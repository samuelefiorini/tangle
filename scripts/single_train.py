...
Train the tangle keras model on the data extracted by `extract_sequences.py` and
...
from tangle.plotting import (plot_confusion_matrix, plot_history,
                             plot_roc_curve)
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='tangle training.')
