...
# --- Train model --- #
# clear; python scripts/single_train.py -l tmp/1_METONLY_vs_METX/matched_CEM_table.csv -d tmp/item_days_raw_data_.pkl -e tmp/embedding.50d.csv -m baseline -o tmp/baseline

# --- Cross validate model -- #
clear; python scripts/cross_validate.py -n 10 -l tmp/1_METONLY_vs_METX/matched_CEM_table.csv -d tmp/item_days_raw_data_.pkl -e tmp/embedding.50d.csv -m proposed -o tmp/proposed_cv
